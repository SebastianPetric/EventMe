...
public class TaskOrganizersListAdapter extends
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup arg0, int arg1) {
        View itemView = LayoutInflater.from(arg0.getContext()).inflate(
                R.layout.list_task_organizers_row, arg0, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            nameTextView = (TextView) itemView.findViewById(R.id.textViewListTaskOrganizersRowName);
            prenameTextView = (TextView) itemView.findViewById(R.id.textViewListTaskOrganizersRowPrename);
            emailTextView = (TextView) itemView.findViewById(R.id.textViewListTaskOrganizersRowEmail);
            addButton= (ImageButton) itemView.findViewById(R.id.imageButtonAddToTask);
